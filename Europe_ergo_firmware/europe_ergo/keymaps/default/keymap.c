...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_6x9(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                       /**/                    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NLCK,
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPACE,   TG(layer),                                         /**/                                      TG(layer),   KC_PGDN, KC_RGUI, FN,      KC_RCTL,
                                                                       KC_NO,              /**/           KC_UP,
    ...
    [_NORWEGIAN] = LAYOUT_6x9(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPACE,   TG(layer),                                         /**/                                      TG(layer),   KC_RALT, KC_RGUI, KC_PGDN, KC_RCTL,
                                                                       KC_NO,              /**/           KC_UP,
                                                              KC_NO,   KC_NO,   KC_NO,     /**/  KC_LEFT, KC_DOWN, KC_RIGHT
    )
};
