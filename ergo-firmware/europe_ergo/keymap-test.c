...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_LSFT, KC_NUBS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_DEL,   KC_NO,    /**/     KC_UP, KC_END,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_PGUP, KC_RSFT,
        KC_LCTL, KC_LGUI, KC_LALT, KC_SPACE, TG(_NORWEGIAN),KC_NO,   KC_NO,   KC_NO,       /**/    KC_LEFT, KC_DOWN, KC_RIGHT,  TG(_NORWEGIAN),  KC_PGDN, KC_RGUI, FN, KC_RCTL,
    ...
    [_NORWEGIAN] = LAYOUT(
        ...
        KC_LSFT, NO_LABK, NO_Z,    NO_X,    NO_C,    NO_V,    NO_B,    KC_DEL,  KC_NO,     /**/          KC_UP,  KC_END,  NO_N,    NO_M,    NO_COMM, NO_DOT,  NO_MINS, KC_PGUP, KC_RSFT,
