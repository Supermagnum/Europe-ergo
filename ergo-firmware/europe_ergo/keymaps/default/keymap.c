...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT(
        ...
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,               /**/           KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_SCRL, KC_PAUS, KC_BSPC,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_INS,             /**/           KC_HOME, KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_PSCR,
    ...
    [_NORWEGIAN] = LAYOUT(
        ...
        NO_PIPE, NO_1,    NO_2,    NO_3,    NO_4,    NO_5,    NO_6,    NO_7,               /**/           NO_8,    NO_9,    NO_0,    NO_PLUS, NO_BSLS, KC_SCRL, KC_PAUS, KC_BSPC,
        KC_TAB,  NO_ARNG,  NO_SCLN, NO_COLN, NO_P ,    NO_Y,  NO_F  ,    KC_INS,           /**/           KC_HOME, NO_G,    NO_C,    NO_R,    NO_P,     NO_ASTR, NO_TILD, KC_PSCR,
        KC_CAPS, NO_A,    NO_O,    NO_E,    NO_U,    NO_I,    NO_D,                        /**/                    NO_H,    NO_T,    NO_N,    NO_S, NO_MINS,   NO_RABK, KC_ENT,
        KC_LSFT, NO_OSTR, NO_AE,    NO_Q,    NO_J,    NO_K,    NO_X,    KC_DEL,            /**/           KC_END,  NO_B,    NO_M,    NO_W, NO_V,  NO_Z, KC_PGUP, KC_RSFT,
    ...
    [_NUM] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                       /**/                    KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_TRNS,
        NO_PIPE, KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,        /**/           KC_NO,    KC_NO,   KC_NO,    NO_PLUS, NO_BSLS, KC_SCRL, KC_PAUS, KC_BSPC,
        KC_TAB,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_INS,       /**/           KC_HOME, KC_KP_7,    KC_KP_8,    KC_KP_9,    NO_P,    NO_ARNG, KC_RBRC, KC_PSCR,
